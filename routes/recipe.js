...
router.post("/new",async(req,res)=> {
    try {
        ...
        const newRecipe = await pool.query("INSERT INTO recipes (recipe_name, recipe_ingredients, recipe_instructions, user_id) VALUES ($1,$2,$3,$4) RETURNING *", [name, ingredients, instructions, user_id])
...
router.put("/edit/:id", authorization, async(req, res)=>{
    try{
        ...
        const recipe = await pool.query("UPDATE recipes SET recipe_name=$1, recipe_ingredients=$2, recipe_instructions=$3, recipe_favorite=$4 WHERE recipe_id=$5 RETURNING * ", [req.body.recipe_name, req.body.recipe_ingredients, req.body.recipe_instructions, req.body.recipe_favorite, recipeId
        ])
